     ...
     const crearNuevaCita = e => {
          ...
          clienteAxios.post('/pacientes', cita)
               .then(respuesta => {
                    ...
                    // Manda true a consultar por medio de su set, para que realice una nueva consulta a la BD.
               ...
               <div className="container mt-5 py-5">
                    <div className="row">
                         ...
                         <div className="col-md-8 mx-auto">
                              <form 
                              onSubmit={crearNuevaCita} className="bg-white p-5 bordered">
